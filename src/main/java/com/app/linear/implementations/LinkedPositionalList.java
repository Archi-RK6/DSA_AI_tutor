...
import com.app.linear.interfaces.PositionalList;
...
public class LinkedPositionalList<E> implements PositionalList<E>, Iterable<E> {
    ...
    private static class Node<E> implements Position<E> {
        ...
        public String toString() {
            // helpful for debugging: Position(element=@hash)
            return "Pos(" + String.valueOf(element) + "@" + System.identityHashCode(this) + ")";
        }
    }
