...
import com.app.nonlinear.implementations.RBTreeMap;
...
public class RBTreeMapAdapter implements DataStructureAdapter {

    private final RBTreeMap<String, String> map = new RBTreeMap<>();
    ...
    public List<Step> operate(OperationRequest r) {
        ...
        switch (op) {
            ...
            default -> throw new IllegalArgumentException("Unsupported operation for RED_BLACK_TREE: " + op);
        }
