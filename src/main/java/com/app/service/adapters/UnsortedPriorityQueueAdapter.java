...
public class UnsortedPriorityQueueAdapter implements DataStructureAdapter {

    private final UnsortedPriorityQueue<String, String> pq = new UnsortedPriorityQueue<>();
    ...
    public List<Step> operate(OperationRequest r) {
        ...
        switch (op) {
            ...
            default -> throw new IllegalArgumentException("Unsupported operation for UNSORTED_PRIORITY_QUEUE: " + op);
        }
