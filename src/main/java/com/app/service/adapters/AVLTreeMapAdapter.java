...
public class AVLTreeMapAdapter implements DataStructureAdapter {

    private final AVLTreeMap<String,String> map = new AVLTreeMap<>();
    ...
    public List<Step> operate(OperationRequest r) {
        ...
        switch (op) {
            ...
            default -> throw new IllegalArgumentException("Unsupported operation for AVL_TREE: " + op);
        }
        return steps;
    }
    ...
    // ---- helpers (те же, что в TreeMapAdapter) ----
